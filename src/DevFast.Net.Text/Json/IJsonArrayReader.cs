...
public interface IJsonArrayReader : IDisposable
{
    ...
    IEnumerable<RawJson> EnumerateJsonArray(bool ensureEoj, Token token = default);
    ...
    /// <param name="token">Cancellation token to observe</param>
    /// <exception cref="JsonEx"></exception>
    void ReadIsBeginArrayWithVerify(Token token = default);
    ...
    /// </summary>
    /// <param name="token">Cancellation token to observe</param>
    bool ReadIsBeginArray(Token token = default);
    ...
    /// <param name="token">Cancellation token to observe</param>
    /// <exception cref="JsonEx"></exception>
    bool ReadIsEndArray(bool ensureEoj, Token token = default);
    ...
    /// <param name="token">Cancellation token to observe.</param>
    /// <exception cref="JsonEx"></exception>
    RawJson ReadRaw(bool withVerify = true, Token token = default);
}
