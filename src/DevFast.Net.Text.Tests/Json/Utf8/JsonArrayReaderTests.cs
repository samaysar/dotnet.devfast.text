...
namespace DevFast.Net.Text.Tests.Json.Utf8
{
    internal class JsonArrayReaderTests
    {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("", withPreamble);
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("[]");
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("[9]");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith(keepRange ? "[]" : "[");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith(addValueSeparator ? "9,8" : "9 8");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("u");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("{1]");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("\"\\\\\\/\\\"\\b\\f\\n\\t\\r\\u0000\"");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
        ...
        public async Task ReadRaw_Throw_Error_When_String_Contains_Invalid_Escape_Character()
        {
            ...
            using Stream m1 = TestHelper.GetReadableStreamWith("\"\\");
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("\"\\u0\"");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("\"0");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("tru");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
            ...
            using Stream m1 = TestHelper.GetReadableStreamWith("fals");
            using IJsonArrayReader rr = await JsonReader.CreateUtf8ArrayReaderAsync(m1, CancellationToken.None, disposeStream: true);
            err = Throws<JsonException>(() => rr.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("nul");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("{\"a\":1");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
            ...
            using Stream m1 = TestHelper.GetReadableStreamWith("[1");
            using IJsonArrayReader rr = await JsonReader.CreateUtf8ArrayReaderAsync(m1, CancellationToken.None, disposeStream: true);
            err = Throws<JsonException>(() => rr.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("{\"a\":1 \"b\":2}");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
            ...
            using Stream m1 = TestHelper.GetReadableStreamWith("[1 1]");
            using IJsonArrayReader rr = await JsonReader.CreateUtf8ArrayReaderAsync(m1, CancellationToken.None, disposeStream: true);
            err = Throws<JsonException>(() => rr.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        public async Task ReadRaw_Throws_Error_When_Array_Or_Object_Is_Not_Well_Defined()
        {
            ...
            using Stream m11 = TestHelper.GetReadableStreamWith("{");
            ...
            using Stream m2 = TestHelper.GetReadableStreamWith("[1,");
            ...
            using Stream m3 = TestHelper.GetReadableStreamWith("[");
            ...
            using Stream m33 = TestHelper.GetReadableStreamWith("[ ");
        ...
        {
            using Stream m = TestHelper.GetReadableStreamWith("/my");
            using IJsonArrayReader r = await JsonReader.CreateUtf8ArrayReaderAsync(m, CancellationToken.None, disposeStream: true);
            JsonException err = Throws<JsonException>(() => r.ReadRaw(false))!;
            Multiple(() =>
            {
        ...
        {
            using FileStream f = new(Guid.NewGuid().ToString() + ".json",
